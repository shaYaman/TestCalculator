...
//
describe('Calculator - Core Functionality1', () => {
  ...
  it('should correctly calculate 2 + 7 = 9 after clearing mid-way', () => {
    // Start by entering 5 and pressing +
    cy.get('#btn-5').click();
    cy.get('[id="result"]').should('have.text', '5');

    cy.get('#btn-add').click();
    cy.get('#expression').should('have.text', '5 +');

    // Now hit AC to reset everything
    cy.get('#btn-ac').click();
